...
if __name__ == '__main__':
    ...
    parser.add_argument('--asynchronous', "-a", action='store_true', help='NEW! Run with asynchronous sorter.')
    args = parser.parse_args()
    logging.getLogger().setLevel(logging.INFO)
    sys.excepthook = exception_handler
    threading.excepthook = exception_handler
    Server.run(BrickCategoryConfig(args.brick_category_config), args.asynchronous)

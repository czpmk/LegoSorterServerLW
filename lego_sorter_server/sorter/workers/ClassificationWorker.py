...
class ClassificationWorker(Worker):
    def __init__(self, analysis_service: AnalysisService, callback: Callable[[int, ClassificationResult], None]):
        super().__init__()
    ...
    def __classify(self, brick_id: int, image: Image):
        ...
        if len(classification_results_list) == 0:
            ...
            self._callback(brick_id, classification_results_list[0])
